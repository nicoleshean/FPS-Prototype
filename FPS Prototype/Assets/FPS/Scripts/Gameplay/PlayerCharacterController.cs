...
namespace Unity.FPS.Gameplay
{
    ...
    public class PlayerCharacterController : MonoBehaviour
    {
        ...
        public float RotationMultiplier
        {
            get
            {
                if (m_WeaponsManager.IsAiming) //if ads
                {
                    return AimingRotationMultiplier; //set sensitivity multiplier to ads multiplier specified in inspector
                }

                return 1f; //no multiplier if not ads
            }
        }
        ...
        void Start()
        {
            ...
            UpdateCharacterHeight(true); //forces heigh to max without smooth
        }
